...
Fn_MultiArray_FieldEqual(Obj,para_key)
...
Fn_MultiArray_FieldAre(Obj,para_key,para_value)
{ ;compairs values a 2D array to all be the input value or not 
	Loop % Obj.MaxIndex() {
		if (Obj[A_Index,para_key] != para_value) {
			return false
		}		
	}
return true
